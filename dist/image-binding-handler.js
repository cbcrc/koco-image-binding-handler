(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['knockout', 'jquery', 'koco-image-utilities', 'koco-mapping-utilities'], factory);
    } else if (typeof exports !== "undefined") {
        factory(require('knockout'), require('jquery'), require('koco-image-utilities'), require('koco-mapping-utilities'));
    } else {
        var mod = {
            exports: {}
        };
        factory(global.knockout, global.jquery, global.kocoImageUtilities, global.kocoMappingUtilities);
        global.imageBindingHandler = mod.exports;
    }
})(this, function (_knockout, _jquery, _kocoImageUtilities, _kocoMappingUtilities) {
    'use strict';
